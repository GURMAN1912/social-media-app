...
import { useDispatch } from "react-redux";  // Fix capitalization here
...
const Form = () => {
    ...
    const isNonMobile = useMediaQuery("(min-width:600px)");  // Fixed media query
    ...
    const register = async (values, onSubmitProps) => {
        ...
        console.log(formData);  // Fixed console.log
